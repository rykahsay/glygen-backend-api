...
import csv
import traceback
import seqmapping_apilib as apilib
import errorlib
import util
import cgi
import datetime
...
@app.route('/seqmapping/search/', methods=['GET', 'POST'])
def search():
    ...
    try:
        ...
        res_obj = errorlib.get_error_obj("seqmapping_search", traceback.format_exc(), path_obj)
