...
import csv
import traceback
import commonquery_apilib as apilib
import errorlib
import util
...
@app.route('/commonquery/search/', methods=['GET', 'POST'])
def commonquery_search():
    ...
    try:
        ...
        if query_value == "":
            ...
            res_obj = apilib.commonquery_search(query_obj, config_obj)
    except Exception, e:
        res_obj = errorlib.get_error_obj("commonquery_search", traceback.format_exc(), path_obj)
